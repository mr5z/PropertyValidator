...
The example below is used in Xamarin Forms along with [Prism](https://github.com/PrismLibrary/Prism) to register the service in the [DI](https://stackoverflow.com/q/130794/2304737) library, but it can be used also in other platforms supported by the .NET family.
